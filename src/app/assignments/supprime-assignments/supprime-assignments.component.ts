...
@Component({
  selector: 'app-supprime-assignments',
  templateUrl: './supprime-assignments.component.html',
  styleUrls: ['./supprime-assignments.component.css']
})
export class SupprimeAssignmentsComponent {
